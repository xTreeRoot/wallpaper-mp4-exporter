(function () {
  ...
  const messages = {
    en: {
      ...
      idle: 'Idle',
      ready: 'Ready.',
      noDefaultSource: 'No local cache folder was detected automatically. Choose a source file or folder to start.',
      files: 'Files',
      found: '{count} found',
      ...
      aesMissing: 'AES support missing',
    ...
    'zh-CN': {
      ...
      idle: '空闲',
      ready: '准备就绪。',
      noDefaultSource: '没有自动检测到本地缓存目录。请选择一个来源文件或文件夹后开始。',
      files: '文件',
      found: '找到 {count} 个',
